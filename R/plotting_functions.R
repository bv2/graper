# plotting_functions This file contains functions used for plotting diagnositcs for the grpRR model fit - plotPosterior: Plot
# posterior ditribution on parameters beta, gamma and tau - plotVBFit: Plot convergence of parameters (parameter values vs.
# iteration)
...
plotVBFit <- function(result, whichParam = c("ELB", "tau", "beta", "gamma")) {
    ...
    if ("ELB" %in% whichParam & "ELB" %in% whichParam) 
        grid.arrange(gg_ELB, gg_tau, nrow = 2) else if ("ELB" %in% whichParam) 
